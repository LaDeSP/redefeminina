...
<section>
    <div class="container">
        <div class="row">
            ...
            <h2 class="section-titulo"> JURAMENTO DAS VOLUNTÁRIAS </h2>
            <div class="divisoria"> <img src="../img/themes/divisoria-rosa.png"> </div>

            <div class="sobre">

                <p>
                    Prometo como voluntária da Rede Feminina de Combate ao Câncer assumir solene compromisso de assistir com dedicação,
                    despreendimento, amor e espírito de fé todas as pessoas necessitadas esperando que elas possam sentir e, ver em nós,
                    uma transparência de Maria Mãe e modelo de todas as virtudes. Que ela nos abençoe e proteja para cumprirmos a missão de
                    levar apoio, carinho e esperança aos doentes, fazendo sigilo a imagem de respeito.
                </p>

                <p> <b> PRECE DAS VOLUNTÁRIAS </b> </p>

                <p>
                    Senhor, Pai de todos nós, faz-me lembrar sempre dos que sofrem na mente e
                    no corpo, faz de mim um instrumento da tua paz. Onde houver alguém desesperado, que eu leve alegria.
                    Não me deixe esquecer a responsabilidade de ajudar ao próximo. Faz-me ver quanto a minha vida se enriquece toda
                    vez que conforto e sirvo a alguém. Põe no meu coração o carinho pelos que repousam com dor Senhor, ajuda-me a não ser egoísta,
                    a não buscar pretextos para fugir ao dever de ajudar. Oh! Pai bem amado guia os pesquisadores de todo o mundo para que descubram
                    a solução final para o problema do câncer. Que eu compreenda o privilégio e a importância de ser voluntária nesta cruzada heróica,
                    infatigável para vencermos o inimigo cruel que se chama câncer.
                </p>

                <p> <b> HINO ROSAS DE AMOR </b> </p>

                <p>
                    Fica sempre algum perfume <br>
                    Nas mãos abençoadas <br>
                    Que oferecem rosas <br>
                    Rosas desabrochando amor <br>
                    Perfumando de paz <br>
                    Os dias de aflição <br>
                    Rosas cheias de perdão <br>
                    Para aqueles que sentem <br>
                    A dor do seu caminho <br>
                    Rosas que brotam do coração <br>
                    E se desfolham <br>
                    Em suave carinho <br>
                    Que o perfume dessas rosas <br>
                    Possam abençoar <br>
                    As nossas mãos <br>
                </p>
            </div>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>		<script src="<?php echo PATHSITE ?>/public/js/newsTicker.min.js"> </script>
