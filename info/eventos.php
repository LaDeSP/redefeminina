			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12 events">
						...
						<h2 class="section-titulo"> CALENDÁRIO DE EVENTOS </h2>
						<div class="divisoria"> <img src="../img/themes/divisoria-rosa.png"> </div>

						<?php
						include_once dirname(__DIR__) . '/profile/classes/conexao.class.php';
						include_once dirname(__DIR__) . '/profile/classes/daoadministrador.class.php';
						...
						foreach ($administrador as $adm) {
							...
							$dataEvento = DateTime::createFromFormat ('d/m/Y', $adm->data_evento, $timeZone);
							if($dataEvento >= $hoje) {
								$cont++;
								?>

								<article class="col-md-12">
									<img src="../img/themes/calendario.png" class="img-responsive">
									<h4> <?php echo $adm->nome_evento ?> </h4>
									<i class="fa fa-map-marker" aria-hidden="true"> <?php echo $adm->endereco_evento ?> </i> &nbsp;
									<i class="fa fa-calendar-check-o" aria-hidden="true"> <?php echo $adm->data_evento ?> </i>
									<i class="fa fa-clock-o" aria-hidden="true"> <?php echo $adm->hora_evento ?> Hrs </i> &nbsp;
									<p> <?php echo $adm->informacao_evento ?> </p> <br>
								</article>
						...
						if ($cont == 0) {
							echo "<h4 class='text-center' style='margin-bottom: 3%'> Nenhum Evento Adicionado!!! </h4>";
						}
