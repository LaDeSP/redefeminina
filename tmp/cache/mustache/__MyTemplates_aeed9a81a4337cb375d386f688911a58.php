...
class __MyTemplates_aeed9a81a4337cb375d386f688911a58 extends Mustache_Template
{
...
';
        $buffer .= $indent . '				<a href="/luta_contra_cancer"><img src="img/cancer.png" alt="" class="img-thumbnail mx-sm d-block m-3"></a>
';
        $buffer .= $indent . '			</div>
';
        $buffer .= $indent . '			<!--div class="col-md">
