...
class __MyTemplates_1bcea6f0c73b1b80fa00615bf072d9d1 extends Mustache_Template
{
...
';
        $buffer .= $indent . '				<a href="/post/luta_contra_cancer"><img src="img/cancer.png" alt="" class="img-thumbnail mx-auto d-block m-3"></a>
';
        $buffer .= $indent . '			</div>
';
        $buffer .= $indent . '			<!--div class="col-md">
...
';
        $buffer .= $indent . '			<div class="col-md">
';
        $buffer .= $indent . '				<a href="/post/outubro_rosa"><img src="img/outubro-rosa.png" alt="" class="img-thumbnail mx-auto d-block m-3"></a>
';
        $buffer .= $indent . '			</div>
';
        $buffer .= $indent . '			<div class="col-md">
';
        $buffer .= $indent . '				<a href="/post/como_ajudar"><img src="img/ajuda.png" alt="" class="img-thumbnail mx-auto d-block m-3"></a>
';
        $buffer .= $indent . '			</div>
';
        $buffer .= $indent . '		</div>
...
';
        $buffer .= $indent . '		';
        $value = $this->resolveValue($context->findDot('home.quemSomos'), $context);
        $buffer .= call_user_func($this->mustache->getEscape(), $value);
        $buffer .= '
';
        $buffer .= $indent . '	</div>
