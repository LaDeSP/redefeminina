...
class __MyTemplates_90b8f6d01823ca3506c69973a11cda17 extends Mustache_Template
{
...
';
        $buffer .= $indent . '<section class="banner mp-5">
';
...
';
        $buffer .= $indent . '<section class="section mt5">
';
