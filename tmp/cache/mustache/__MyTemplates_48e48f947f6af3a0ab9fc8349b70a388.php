...
class __MyTemplates_48e48f947f6af3a0ab9fc8349b70a388 extends Mustache_Template
{
...
';
        $buffer .= $indent . '				<p>Gostou do projeto? Sente vontade de ajudar? Entre em contato com o numero <strong>32313057</strong>.</p>
';
        $buffer .= $indent . '			</div>
';
        $buffer .= $indent . '		</div>
