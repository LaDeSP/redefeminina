...
class __MyTemplates_ccc56067320885791e6c5fb7dfa06936 extends Mustache_Template
{
...
';
        $buffer .= $indent . '<section class="section mt-5">
';
...
';
        $buffer .= $indent . '				<a href="/luta_contra_cancer"><img src="img/cancer.png" alt="" class="img-thumbnail mx-md d-block m-3"></a>
';
        $buffer .= $indent . '			</div>
';
        $buffer .= $indent . '			<!--div class="col-md">
