...
class __MyTemplates_f6bb94d0b5f40c4e42a306c10df03817 extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        if ($partial = $this->mustache->loadPartial('layout/header_layout.mustache')) {
...
';
        ...
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('layout/footer_layout.mustache')) {
            $buffer .= $partial->renderInternal($context);
        }
