...
class __MyTemplates_73530537bf63f8d7acf3e6f19e4f710f extends Mustache_Template
{
...
';
        $buffer .= $indent . '				<a class="nav-link" href="/site/parceiros">Parceiros</a>
';
        $buffer .= $indent . '			</li>
';
        $buffer .= $indent . '			<!--li class="nav-item">
';
        $buffer .= $indent . '				<a class="nav-link" href="#">Galeria de fotos</a>
';
        $buffer .= $indent . '			</li-->
';
        $buffer .= $indent . '			<li class="nav-item">
';
        $buffer .= $indent . '				<a class="nav-link" href="/site/depoimentos">Depoimentos</a>
';
        $buffer .= $indent . '			</li>
';
        $buffer .= $indent . '			<li class="nav-item">
';
        $buffer .= $indent . '				<a class="nav-link" href="/site/contato">Contato</a>
';
        $buffer .= $indent . '			</li>
';
        $buffer .= $indent . '		</ul>
