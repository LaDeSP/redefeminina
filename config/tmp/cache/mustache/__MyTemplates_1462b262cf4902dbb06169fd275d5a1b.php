...
class __MyTemplates_1462b262cf4902dbb06169fd275d5a1b extends Mustache_Template
{
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        $buffer = '';

        if ($partial = $this->mustache->loadPartial('layouts/header_layout.mustache')) {
...
';
        $buffer .= $indent . '				<a href="/site/luta-contra-o-cancer"><img src="img/cancer.png" alt="" class="img-thumbnail mx-auto d-block m-3"></a>
';
        $buffer .= $indent . '			</div>
';
        $buffer .= $indent . '			<!--div class="col-md">
...
';
        $buffer .= $indent . '			<div class="col-md">
';
        $buffer .= $indent . '				<a href="/site/outubro-rosa"><img src="img/outubro-rosa.png" alt="" class="img-thumbnail mx-auto d-block m-3"></a>
';
        $buffer .= $indent . '			</div>
';
        $buffer .= $indent . '			<div class="col-md">
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('site/footer.mustache')) {
            $buffer .= $partial->renderInternal($context);
        }
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('layouts/footer_layout.mustache')) {
            $buffer .= $partial->renderInternal($context);
        }
