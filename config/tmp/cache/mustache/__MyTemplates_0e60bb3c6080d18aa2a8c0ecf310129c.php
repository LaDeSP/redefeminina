...
class __MyTemplates_0e60bb3c6080d18aa2a8c0ecf310129c extends Mustache_Template
{
...
';
        $buffer .= $indent . '					<div class="card form text-center">
';
        $buffer .= $indent . '						<div class="card-body text-center">
';
        $buffer .= $indent . '							<h5 class="card-title">Special title treatment</h5>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '							<form class="">
';
